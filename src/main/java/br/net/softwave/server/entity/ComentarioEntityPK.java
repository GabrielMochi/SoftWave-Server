...
public class ComentarioEntityPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ComentarioEntityPK other = (ComentarioEntityPK) obj;
	...
	public String toString() {
		return "ComentarioEntityPK [postagem_id=" + postagem_id + ", postagem_areaConhecimento_id="
