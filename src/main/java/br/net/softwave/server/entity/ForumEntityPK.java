...
@Embeddable
public class ForumEntityPK implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ForumEntityPK other = (ForumEntityPK) obj;
	...
	public String toString() {
		return "ForumEntityPK [postagem_id=" + postagem_id + ", postagem_areaConhecimento_id="
