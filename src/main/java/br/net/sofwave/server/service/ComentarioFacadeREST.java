...
public class ComentarioFacadeREST extends AbstractFacade<Comentario> {
    ...
    private ComentarioPK getPrimaryKey(PathSegment pathSegment) {
         ...
         * URI path part is supposed to be in form of 'somePath;id=idValue;comentador=comentadorValue;blogId=blogIdValue;receptor=receptorValue;blogareaConhecimentoid=blogareaConhecimentoidValue'.
